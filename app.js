...
//     let h2 = document.createElement("h2");
//     h2.setAttribute("class", "user-list");
//     h2.innerText = val;
//     container.appendChild(h2);
//   });
// };
...
//   let result = user.filter((filterUser) =>
//     filterUser.toLowerCase().includes(input)
//   );
//   renderUsers(result.length > 0 ? result : ["No results found"]);
// });